  ...
  <div>
    <div class="value" :class="sensorCurrent.sensorName == 'Kierunek wiatru' ? 'center' : null">
      <img
        ...
        :src="'./assets/strzalka_przezroczysta.png'"
      >
      <div :class="checkAlarms">
    ...
    <div class="value">
      <img
        v-if="sensorCurrent.sensorName !== 'Kierunek wiatru'"
        :src="'./assets/strzalka_czerwona.png'"
      >
    ...
    <div class="value">
      <img
        v-if="sensorCurrent.sensorName !== 'Kierunek wiatru'"
        :src="'./assets/strzalka_niebieska.png'"
      >
  ...
  computed: {
    checkAlarms() {
      if (this.sensorCurrent.alarmMax) {
        return "alarmMax";
      } if (this.sensorCurrent.alarmMin) {
        return "alarmMin";
      }
      return "";
